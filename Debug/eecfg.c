 ...
 **************************************************************************/
    ...
    DeclareTask(TaskGuiDashboard);
    DeclareTask(TaskLCD);

    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub,		 /* thread TaskGuiDashboard */
    ...
    const EE_THREAD_PTR EE_terminate_real_th_body[EE_MAX_TASK] = {
        &FuncTaskGuiDashboard,
        &FuncTaskLCD
    };
    /* ready priority */
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        0x2U,		 /* thread TaskGuiDashboard */
        0x1U 		 /* thread TaskLCD */
    };
 ...
 **************************************************************************/
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        {myCounter, AlarmTaskGuiDashboard, EE_ALARM }
    };
 ...
 **************************************************************************/
    const EE_oo_action_ROM_type   EE_oo_action_ROM[EE_ACTION_ROM_SIZE] = {
        ...
        {EE_ACTION_TASK    , TaskGuiDashboard, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 }
    };
